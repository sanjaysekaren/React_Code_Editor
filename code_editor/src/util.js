...
'C#':'CSHARP','Java': 'JAVA','Haskell': 'HASKELL', 'Perl':'PERL', 'PHP':'PHP', 'Python':'PYTHON', 'Ruby':'RUBY'}
export const EDITOR_MODE = {'JavaScript':'javascript','C#':'csharp','Java': 'java','Python':'python', 'Ruby':'ruby' }